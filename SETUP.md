...
Run migrations `0010_billing.sql`, `0011_settings_ext.sql` `0012_templates_messages.sql` and `0013_template_registry.sql`. Admins set price, pro features and payment details
